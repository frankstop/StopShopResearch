...
<body><a class="skip" href="#main">Skip to analysis</a><nav class="shell nav" aria-label="Primary"><a href="index.html">Overview</a><a href="weekly-report.html" aria-current="page">Weekly analysis</a><a href="https://frankiejvaldez.com/projects/stopshopresearch/catalog-history/" target="_top">All items</a><a href="data/weekly-summary.json" target="_blank" rel="noopener">Data contract</a><a href="https://github.com/frankstop/StopShopResearch" target="_blank" rel="noopener noreferrer">Source</a></nav>
...
<body><a class="skip" href="#main">Skip to content</a><nav class="shell nav" aria-label="Primary"><a href="index.html" aria-current="page">Overview</a><a href="weekly-report.html">Weekly analysis</a><a href="https://frankiejvaldez.com/projects/stopshopresearch/catalog-history/" target="_top">All items</a><a href="data/weekly-summary.json" target="_blank" rel="noopener">Data contract</a><a href="https://github.com/frankstop/StopShopResearch" target="_blank" rel="noopener noreferrer">Source</a></nav>
